...
public class SBManager {
    ...
    public static void setScoreboard(Player player) {
        ...
        obj.getScore("§8• §r§fDein Rang").setScore(7);
        if(player.hasPermission("server.owner")) {
            obj.getScore("§8➥ §r§4Owner").setScore(7);
        }else if(player.hasPermission("server.mod")) {
            obj.getScore("§8➥ §r§9Mod").setScore(7);
        }else if(player.hasPermission("server.dev")) {
            obj.getScore("§8➥ §r§bDev").setScore(7);
        }else if(player.hasPermission("server.sup")) {
            obj.getScore("§8➥ §r§3Sup").setScore(7);
        }else if(player.hasPermission("server.builder")) {
            obj.getScore("§8➥ §r§2Builder").setScore(7);
        }else if(player.hasPermission("server.youtube")) {
            obj.getScore("§8➥ §r§5YouTuber").setScore(7);
        }else if(player.hasPermission("server.freund")) {
            obj.getScore("§8➥ §r§aFreund").setScore(7);
        }else if(player.hasPermission("server.savage")) {
            obj.getScore("§8➥ §r§5Savage").setScore(7);
        }else if(player.hasPermission("server.ultra")) {
            obj.getScore("§8➥ §r§dUltra").setScore(7);
        }else if(player.hasPermission("server.premium+")) {
            obj.getScore("§8➥ §r§ePremium§7+").setScore(7);
        }else if(player.hasPermission("server.premium")) {
            obj.getScore("§8➥ §r§6Premium").setScore(7);
        }else {
            obj.getScore("§8➥ §r§7Spieler").setScore(7);
        }
