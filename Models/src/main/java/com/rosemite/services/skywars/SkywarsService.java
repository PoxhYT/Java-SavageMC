...
public class SkywarsService {
    ...
    public SkywarsService(MongoDatabase db, IService mainService) {
        this.service = mainService;
        this.db = db;
        allKits = new ArrayList<>();
    }

    public void initializeKits(String uuid) {
    ...
    public void buyKit(String uuid, String kitName) {
        UpdateResult result = db.getCollection(Paths.PlayerSkywarsKits.toString())
                .updateOne(
                Filters.eq("uuid", uuid),
