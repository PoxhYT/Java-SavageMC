...
public class LocationAPI {
    ...
    private static File file = new File("plugins/MLGRush", "Locations.yml");
    ...
    public static void setSpawn(String name, Location loc) {
        ...
        if (!file.exists()) {
            try {
                file.createNewFile();
                Bukkit.getConsoleSender().sendMessage(Main.prefix + "§eLocations.yml wurde erfolgreich erstellt!");
            } catch (Exception exception) {}
        } else {
            Bukkit.getConsoleSender().sendMessage(Main.prefix + "Locations.yml wurde erfolgreich geladen");
        }
    }
